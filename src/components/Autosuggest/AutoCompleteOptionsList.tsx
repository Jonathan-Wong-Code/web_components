...
const StyledListItem = styled.li<{
  ...
  cursor: pointer;
  background-color: ${({ isHighlighted, optionHighlightColour }) =>
    isHighlighted ? optionHighlightColour : 'transparent'};
...
export const AutoCompleteOptions = ({
  optionHighlightColour,
  numVisibleItems = 4,
}: IAutoCompleteOptions): JSX.Element => {
