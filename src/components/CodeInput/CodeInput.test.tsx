...
describe('<CodeInput>', () => {
  ...
  it('should render the default value', () => {
    ...
    expect(
      screen.getByLabelText(/Enter code number at position 1/i)
    ).toHaveValue('1');
    expect(
      screen.getByLabelText(/Enter code number at position 2/i)
    ).toHaveValue('2');
    expect(
      screen.getByLabelText(/Enter code number at position 3/i)
    ).toHaveValue('3');
  });
  ...
  it('should focus the next input when the previous inputs value is changed', () => {
    ...
    const inputThree = screen.getByLabelText(
      /Enter code number at position 3/i
    );
